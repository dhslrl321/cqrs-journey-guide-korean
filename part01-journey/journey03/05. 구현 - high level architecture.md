...
팀은 이후에 시스템이 order 를 잘 생성하고 저장했는지 확인하기 위한 로직을 [\*Post-Redirect-Get Pattern](https://github.com/dhslrl321/cqrs-journey-korean-ver/blob/master/terms/Post-Redirect-Get%20Pattern.mdwn) 으로 대체했다.
