...
# [\*Anti-Corruption Layers](https://github.com/dhslrl321/cqrs-journey-korean-ver/blob/master/terms/Anti%20Corruption%20Layers.mdwn), 손상 방지 레이어
...
DDD 접근 방식은 Anti-Corruption Layers 를 사용하거나 [Shared Kernel](https://github.com/dhslrl321/cqrs-journey-korean-ver/blob/master/terms/Shared%20Kernel.mdwn) 을 사용하는 것과 같은 여러 바운디드 컨텍스트 사이에서 여러 모델 간의 상호 작용을 처리하기 위한 다양한 접근 방식을 제공한다
